...
const int pushbuttonPin = A3; // Push button to change direction
...
void motorFunction() {
  int pushButtonValue = analogRead(pushbuttonPin); // Get the value of the push button
  float voltage3 = pushButtonValue * (5.0 / 1023.0); // Convert the value to a voltage

  if (voltage3 < 4) { // Check if push button is pressed
