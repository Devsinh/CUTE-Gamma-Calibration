...
const MotorTab = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const newSignal = signalResponse.data.signal;
      
      // Update signal history, keeping only the last 50 entries
      setSignalHistory(prevHistory => {
        const updatedHistory = [...prevHistory, newSignal];
        return updatedHistory.slice(-50); // Keep only the last 50 entries
      });
      ...
      <Grid container spacing={1} direction="column" justifyContent="center" alignItems="center">
        ...
        <Grid item>
          <Grid container spacing={1} direction="column" justifyContent="center" alignItems="center">
            ...
            {isGraphVisible && (
              <Grid item>
                <MotionSensorGraph signalData={signalHistory} />
              </Grid>
            )}
